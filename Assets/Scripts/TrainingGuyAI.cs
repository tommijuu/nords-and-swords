...
public class TrainingGuyAI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _finalDamage = 0f;
        _weaponDamage = gm.trainingGuyAttributes.GetBaseDamage(gm.trainingGuyLevel);
        ...
        _staminaTotalRecoveryMultiplier = 1 + _staminaRecoveryMultiplier * gm.trainingGuyAttributes.GetSta(gm.trainingGuyLevel);
    ...
    public IEnumerator EnemyTurn(float waitTime)
    {
        ...
        {
            activeWeapon = GetComponent<TraniningGuySquire>().activeWeapon;
            Action a;
            switch (state)
            {
    ...
    public IEnumerator PlungeTrail()
    {
        ...
        activeWeapon.transform.GetChild(3).gameObject.SetActive(true);
        yield return new WaitForSeconds(0.45f);
        activeWeapon.transform.GetChild(3).gameObject.SetActive(false);
    }
    ...
    public void HeavyAttack()
    {
        ...
        if (staminaBar != null)
        {
            float totalCost = (_staminaAttackBase + gm.trainingGuyAttributes.GetStr(gm.trainingGuyLevel) * _staminaHeavyAttackMultiplier);
        ...
        if (healthBar != null)
        {
            ...
            float hitChance = (gm.trainingGuyAttributes.GetAtk(gm.trainingGuyLevel) * attackType * attackMultiplier) / ((gm.trainingGuyAttributes.GetAtk(gm.trainingGuyLevel) + PlayerAttributes.pDef) + playerDefenseMultiplier);
            float hitRandom = Random.Range(0.00001f, 10.00000000001f) / 10;
            _finalDamage = 0;
            _finalDamage = (gm.trainingGuyAttributes.GetStr(gm.trainingGuyLevel) * 2 + _weaponDamage) * 1.5f;
    ...
    public IEnumerator MediumAttackTrail()
    {
        ...
        yield return new WaitForSeconds(0.5f);
        activeWeapon.transform.GetChild(4).gameObject.SetActive(true);
        yield return new WaitForSeconds(0.8f);
        activeWeapon.transform.GetChild(4).gameObject.SetActive(false);
    }
    public void MediumAttack()
    {
        ...
        if (staminaBar != null)
        {
            float totalCost = (_staminaAttackBase + gm.trainingGuyAttributes.GetStr(gm.trainingGuyLevel) * _staminaMediumAttackMultiplier);
            staminaBar.SendMessage("TakeDamage", totalCost);
        }
        if (healthBar != null)
        {
            //effect.GetComponent<Effect>().PlayEnemyMedium();
            enemyAnimator.SetTrigger("MediumAttack");
            StartCoroutine(MediumAttackTrail());
            float hitChance = (gm.trainingGuyAttributes.GetAtk(gm.trainingGuyLevel) * attackType * attackMultiplier) / ((gm.trainingGuyAttributes.GetAtk(gm.trainingGuyLevel) + PlayerAttributes.pDef) + playerDefenseMultiplier);
            float hitRandom = Random.Range(0.00001f, 10.00000000000000001f) / 10;
            _finalDamage = 0;
            _finalDamage = (gm.trainingGuyAttributes.GetStr(gm.trainingGuyLevel) * 2 + _weaponDamage) * 1f;
    ...
    public IEnumerator QuickAttackTrail()
    {
        ...
        yield return new WaitForSeconds(0.2f);
        activeWeapon.transform.GetChild(5).gameObject.SetActive(true);
        yield return new WaitForSeconds(0.45f);
        activeWeapon.transform.GetChild(5).gameObject.SetActive(false);
    }
    public void QuickAttack()
    {
        ...
        if (staminaBar != null)
        {
            float totalCost = (_staminaAttackBase + gm.trainingGuyAttributes.GetStr(gm.trainingGuyLevel) * _staminaQuickAttackMultiplier);
        ...
        if (healthBar != null)
        {
            ...
            _finalDamage = 0;
            _finalDamage = (gm.trainingGuyAttributes.GetStr(gm.trainingGuyLevel) * 2 + _weaponDamage) * 0.7f;
    ...
    IEnumerator WalkForward()
    {
        ...
        float waitTime = 1f + waitScalar * gm.trainingGuyAttributes.GetAgi(gm.trainingGuyLevel);
        yield return new WaitForSeconds(waitTime);
    ...
    IEnumerator JumpBackward()
    {
        ...
        enemyAnimator.SetTrigger("JumpBackwards");
        yield return new WaitForSeconds(0.11f);
        //rb.AddForce(move * agilityMultiplier * jumpMultiplier, ForceMode.Impulse);
        rb.AddForce((Vector3.right + Vector3.up) * agilityMultiplier * jumpMultiplier);
    ...
    IEnumerator JumpForward()
    {
        ...
        enemyAnimator.SetTrigger("JumpForward");
        yield return new WaitForSeconds(0.11f);
        rb.AddForce((Vector3.left + Vector3.up) * agilityMultiplier * jumpMultiplier);
